    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light border-bottom">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo e(url('/admin')); ?>" class="nav-link" data-bs-toggle="tooltip"
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/admin" class="brand-link">
                <img src="<?php echo e(url('/assets/img/gallery/logo gobiernodechile.jpg')); ?>" alt=""
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="info">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="#" class="d-block"><?php echo e(Auth::user()->name . ' ' . Auth::user()->apellido); ?></a>
                        <?php else: ?>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.admin_urgencias.index')): ?>
                            <li class="nav-item has-treeview">
                                <a href="#" class="nav-link active">
                                    <i class="nav-icon fas bi bi-people-fill"></i>
                                    <p>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/admin_urgencias/create')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Creación de usuarios</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/admin_urgencias')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Listado de usuarios</p>
                                        </a>
                                    </li>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.admin_enfermeros.index')): ?>
                            <li class="nav-item has-treeview">
                                <a href="#" class="nav-link active">
                                    <i class="nav-icon fas bi bi-people-fill"></i>
                                    <p>
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/admin_enfermeros/create')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Creación de usuarios</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/admin_enfermeros')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Listado de usuarios</p>
                                        </a>
                                    </li>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.admisiones.index')): ?>
                            <li class="nav-item has-treeview">
                                <a href="#" class="nav-link active">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/admisiones/create')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Creación de usuarios</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/admisiones')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Listado de usuarios</p>
                                        </a>
                                    </li>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.enfermeros.index')): ?>
                            <li class="nav-item has-treeview">
                                <a href="#" class="nav-link active">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/enfermeros/create')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Creación Enfermeros/as</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/enfermeros')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.pacientes.index')): ?>
                            <li class="nav-item has-treeview">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.pacientes.create')): ?>
                                        <li class="nav-item">
                                            <a href="<?php echo e(url('admin/pacientes/create')); ?>" class="nav-link active">
                                                <i class="far fa-circle nav-icon"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/pacientes')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.pacientes.condition')): ?>
                                        <li class="nav-item">
                                            <a href="<?php echo e(url('admin/condition')); ?>" class="nav-link active">
                                                <i class="far fa-circle nav-icon"></i>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.panel.index')): ?>
                                        <li class="nav-item">
                                            <a href="<?php echo e(url('admin/panel')); ?>" class="nav-link active">
                                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('admin.moduloTV.index')): ?>
                            <li class="nav-item has-treeview">
                                <a href="<?php echo e(route('admin.panel.tv')); ?>" class="nav-link active">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/moduloTV/create')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="<?php echo e(url('admin/moduloTV')); ?>" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(route('logout')); ?>" class="nav-link" style="background-color: #a9200e"
       ...
       <?php if(session('mensaje') && session('icono')): ?>
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                const rutaActual = window.location.pathname;
                const mensaje = "<?php echo e(session('mensaje')); ?>";
...
<?php /**PATH C:\xampp\htdocs\urgencia_hfbc\resources\views/layouts/admin.blade.php ENDPATH**/ ?>